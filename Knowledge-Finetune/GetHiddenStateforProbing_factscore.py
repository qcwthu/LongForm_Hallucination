...
def getHiddenStates():
    ...
    inputfile_1 = "/data/home/Knowledge-Boundary/factscore/ACE-decomposed-facts/factscore-allfacts-transform2question.json"
    ...
    finalresultpath = "./HiddenStates_factscore/factscore_alldata_hiddenstates-llama3-8b-instruct_greedy.json"
    # finalresultpath = "./HiddenStates_factscore/factscore_alldata_hiddenstates-llama3-8b-instruct_greedy_noinstruction_onlyclaim.json"
    # finalresultpath = "./HiddenStates_factscore/factscore_alldata_hiddenstates-llama3-8b-instruct_greedy_noinstruction_onlyclaim_with_chattemplate.json"
    # finalresultpath = "./HiddenStates_factscore/factscore_alldata_hiddenstates-llama3-8b-instruct_greedy_question_and_claim.json"
    for onekey in allfact_1.keys(): 
