...
def handle_decomposed_facts():
    ...
    #     4: "max_5_prob",
    #     5: "max_5percent_prob",
    #     6: "max_10percent_prob",
    #     7: "max_15percent_prob"
    # }
    idx2name = {
    ...
    for i in range(len(allsupportedres[0])):
        ...
        if i == 1:
            axs[i//4][i%4].set_yticks(np.arange(0, max_y + 5, 20))
        else:
            axs[i//4][i%4].set_yticks(np.arange(0, max_y + 5, 5))
    ...
    # picname = "Figures/entities_temperature_" + str(temperature) + "_entropy_newlegend.png"
    picname = "Figures/entities_temperature_" + str(temperature) + "_entropy_newlegend.pdf"
    plt.savefig(picname)
    print(allsize)
