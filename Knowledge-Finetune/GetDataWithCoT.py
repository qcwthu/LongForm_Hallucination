...
def handle_decomposed_facts():
    ...
    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_CoT.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_CoT.json"
...
def handle_decomposed_facts_true_false_cot():
    ...
    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_true_false_CoT.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_true_false_CoT.json"
    with open(trainpath, "w+") as f:
        json.dump(alltosavetrain, f, indent=4, separators=(",", ": "))
    with open(validpath, "w+") as f:
        json.dump(alltosavevalid, f, indent=4, separators=(",", ": "))
...
def handle_decomposed_facts_paraphrase():
    ...
    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_withpara.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_withpara.json"
    with open(trainpath, "w+") as f:
        json.dump(alltosavetrain_query, f, indent=4, separators=(",", ": "))
    with open(validpath, "w+") as f:
        json.dump(alltosavevalid_query, f, indent=4, separators=(",", ": "))

    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_cot_true_false_withpara.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_cot_true_false_withpara.json"
    with open(trainpath, "w+") as f:
    ...
    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_true_false_cot_withpara.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_true_false_cot_withpara.json"
    with open(trainpath, "w+") as f:
...
def handle_decomposed_facts_different_prompt():
    ...
    for i in range(len(train_data)):
        ...
        train_data[i]["hidden"] = []
    ####save new train_data
    trainpath = "/data/home/Knowledge-Finetune/DifferentPrompt/train_different_prompt.json"
    with open(trainpath, "w+") as f:
    ...
    for i in range(len(valid_data)):
        ...
        if valid_data[i]["label"] == 0:
            ...
            exit -1
        valid_data[i]["hidden"] = []
    validpath = "/data/home/Knowledge-Finetune/DifferentPrompt/valid_different_prompt.json"
    with open(validpath, "w+") as f:
...
def handle_decomposed_facts_prompt2llamadata():
    ...
    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_diff_prompt.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_diff_prompt.json"
    with open(trainpath, "w+") as f:
        json.dump(alltosavetrain_query, f, indent=4, separators=(",", ": "))
    with open(validpath, "w+") as f:
        json.dump(alltosavevalid_query, f, indent=4, separators=(",", ": "))

    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_cot_true_false_diff_prompt.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_cot_true_false_diff_prompt.json"
    with open(trainpath, "w+") as f:
        json.dump(alltosavetrain_cot_true_false, f, indent=4, separators=(",", ": "))
    with open(validpath, "w+") as f:
        json.dump(alltosavevalid_cot_true_false, f, indent=4, separators=(",", ": "))

    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_true_false_cot_diff_prompt.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_true_false_cot_diff_prompt.json"
    with open(trainpath, "w+") as f:
        json.dump(alltosavetrain_true_false_cot, f, indent=4, separators=(",", ": "))
    with open(validpath, "w+") as f:
        json.dump(alltosavevalid_true_false_cot, f, indent=4, separators=(",", ": "))
...
def handle_decomposed_facts_different_prompt_qa_format():
    ...
    for i in range(len(train_data)):
        ...
        train_data[i]["hidden"] = []
    ####save new train_data
    trainpath = "/data/home/Knowledge-Finetune/DifferentPrompt/train_different_prompt_qa_format.json"
    with open(trainpath, "w+") as f:
        json.dump(train_data, f, indent=4, separators=(",", ": "))
    ...
    for i in range(len(valid_data)):
        ...
        if valid_data[i]["label"] == 0:
            ...
            exit -1
        valid_data[i]["hidden"] = []
    validpath = "/data/home/Knowledge-Finetune/DifferentPrompt/valid_different_prompt_qa_format.json"
    with open(validpath, "w+") as f:
        json.dump(valid_data, f, indent=4, separators=(",", ": "))
...
def handle_decomposed_facts_different_prompt_qa_format_llamadata():
    ...
    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_diff_prompt_qa_format.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_diff_prompt_qa_format.json"
    with open(trainpath, "w+") as f:
        json.dump(alltosavetrain_query, f, indent=4, separators=(",", ": "))
    with open(validpath, "w+") as f:
        json.dump(alltosavevalid_query, f, indent=4, separators=(",", ": "))

    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_cot_true_false_diff_prompt_qa_format.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_cot_true_false_diff_prompt_qa_format.json"
    with open(trainpath, "w+") as f:
        json.dump(alltosavetrain_cot_true_false, f, indent=4, separators=(",", ": "))
    with open(validpath, "w+") as f:
        json.dump(alltosavevalid_cot_true_false, f, indent=4, separators=(",", ": "))

    trainpath = "/data/home/LLaMA-Factory/data/automized_claim_train_true_false_cot_diff_prompt_qa_format.json"
    validpath = "/data/home/LLaMA-Factory/data/automized_claim_valid_true_false_cot_diff_prompt_qa_format.json"
    with open(trainpath, "w+") as f:
        json.dump(alltosavetrain_true_false_cot, f, indent=4, separators=(",", ": "))
    with open(validpath, "w+") as f:
        json.dump(alltosavevalid_true_false_cot, f, indent=4, separators=(",", ": "))
