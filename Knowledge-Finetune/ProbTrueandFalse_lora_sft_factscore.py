...
def plot_res(all_support_result, all_contradicted_result):
    ...
    picname = "Figures/factscore_True_False_sft_model" + ".png"
    plt.savefig(picname)
    picname_1 = "Figures/factscore_True_False_sft_model" + ".pdf"
...
def handle_decomposed_facts():
    ...
    model_id = "/data/home/LLaMA-Factory/models/factscore_llama3_8b_automized_claim_classifer_lora_sft_target_all"
    ...
    case_study_res = {
        "all_support_query": all_support_query,
        "all_support_answer": all_support_answer,
        "all_contradicted_query": all_contradicted_query,
        "all_contradicted_answer": all_contradicted_answer
    }

    savepath = "./CaseStudy/factscore_ft.json"
    with open(savepath, "w") as f:
        json.dump(case_study_res, f, indent=4, separators=(",", ": "))
...
def handle_decomposed_facts_cot_true_false():
    ...
    tensor_parallel = 8
    model_id = "/data/home/LLaMA-Factory/models/factscore_llama3_8b_automized_claim_classifer_lora_sft_target_all_cot_true_false_diff_prompt_qa_format"
    ...
    savepath = "./CoTResult/factscore_ft_cot_true_false_diff_prompt_qa_format"
    with open(savepath, "w") as f:
...
def handle_decomposed_facts_true_false_cot():
    ...
    model_id = "/data/home/LLaMA-Factory/models/factscore_llama3_8b_automized_claim_classifer_lora_sft_target_all_true_false_cot_diff_prompt_qa_format"
    ...
    savepath = "./CaseStudy/factscore_ft_cot_diff_prompt_qa_format.json"
    with open(savepath, "w") as f:
        json.dump(case_study_res, f, indent=4, separators=(",", ": "))
