...
class Model():
    ...
    def plot_res(self, all_support_result, all_contradicted_result):
        ...
        picname = "Figures/factscore_True_False_linear_probing" + ".png"
        plt.savefig(picname)
    ...
    def save_data(self):
        ...
        trainpath = "/data/home/LLaMA-Factory/data/factscore_automized_claim_train.json"
        validpath = "/data/home/LLaMA-Factory/data/factscore_automized_claim_valid.json"
    ...
    def save_data_position_bias(self):
        ...
        print(alltosavetrain[0])
        print(alltosavevalid[0])
        trainpath = "/data/home/LLaMA-Factory/data/factscore_automized_claim_train_position_bias.json"
        validpath = "/data/home/LLaMA-Factory/data/factscore_automized_claim_valid_position_bias.json"
        with open(trainpath, "w+") as f:
            json.dump(alltosavetrain, f, indent=4, separators=(",", ": "))
        with open(validpath, "w+") as f:
            json.dump(alltosavevalid, f, indent=4, separators=(",", ": "))
    ...
    def save_data_kto(self):
        ...
        print(alltosavetrain[0])
        print(alltosavevalid[0])
        trainpath = "/data/home/LLaMA-Factory/data/factscore_automized_claim_train_kto_new_instruction.json"
        validpath = "/data/home/LLaMA-Factory/data/factscore_automized_claim_valid_kto_new_instruction.json"
        with open(trainpath, "w+") as f:
            json.dump(alltosavetrain, f, indent=4, separators=(",", ": "))
        with open(validpath, "w+") as f:
            json.dump(alltosavevalid, f, indent=4, separators=(",", ": "))
    ...
    def save_data_dpo(self):
        ...
        print(alltosavetrain[0])
        print(alltosavevalid[0])
        trainpath = "/data/home/LLaMA-Factory/data/factscore_automized_claim_train_dpo.json"
        validpath = "/data/home/LLaMA-Factory/data/factscore_automized_claim_valid_dpo.json"
        with open(trainpath, "w+") as f:
            json.dump(alltosavetrain, f, indent=4, separators=(",", ": "))
        with open(validpath, "w+") as f:
            json.dump(alltosavevalid, f, indent=4, separators=(",", ": "))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default="./HiddenStates_factscore/factscore_alldata_hiddenstates-llama3-8b-instruct_greedy.json", type=str)
    # parser.add_argument("--data_path", default="./HiddenStates_factscore/factscore_alldata_hiddenstates-llama3-8b-instruct_greedy_noinstruction_onlyclaim.json", type=str)
    # parser.add_argument("--data_path", default="./HiddenStates_factscore/factscore_alldata_hiddenstates-llama3-8b-instruct_greedy_noinstruction_onlyclaim_with_chattemplate.json", type=str)
    # parser.add_argument("--data_path", default="./HiddenStates_factscore/factscore_alldata_hiddenstates-llama3-8b-instruct_greedy_question_and_claim.json", type=str)
    ...
    parser.add_argument("--hidden_state_type", default=1, type=int)
